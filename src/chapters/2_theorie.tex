...
Mithilfe dieser Beobachtung konnte Cantor das equimolare Fünf-Komponenten-System \ce{CrMnFeCoNi} entwickeln, welches in
...
\subsubsection{Synthese und Struktur von \heo}\label{subsubsec:heo}
\begin{figure}
    \centering
    ...
    \label{fig:heo}
\end{figure}
Für die Herstellung von \heo wurden die einzelnen binären Oxidpulver \ce{MgO}, \ce{CoO}, \ce{NiO}, \ce{CuO} und \ce{ZnO}
