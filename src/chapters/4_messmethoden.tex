...
Dieser Abschnitt orientiert sich an den Erkenntnissen von \citeauthoryear{afm-buch} \autocite{afm-buch}.
...
\begin{figure}
    ...
    \caption{Schematischer Aufbau eines Auslenkungserkennungssystems. \imcitetwo{afm-handbuch}}
    \label{fig:afm-beam}
\end{figure}
